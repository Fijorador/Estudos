...
void adicionar_par_impar(ListaDupla *l, int v);
void adicionar_ordernado(ListaDupla *l, int v);

int main(){

    ListaDupla *l = criar_lista();

    adicionar_ordernado(l,5);
    adicionar_ordernado(l,10);
    adicionar_ordernado(l,7);
...
void adicionar_par_impar(ListaDupla *l, int v){
    if(v%2==0){
        ...
        printf("Pqp, você descobriu um numero");
    }
}
