...
int contar_impar(Fila *f,Fila *f2);
int contar_par(Fila *f,Fila *f2);
void intercalar_filas(Fila *f,Fila *f2);
...
int x=0,ele,aux=0;
    ...
    if(x==1){
        ...
        enfileirar_fila(f,ele);
            ...
            scanf("%d",&ele);
            enfileirar_fila(f2,ele);
    }
    else if(x==3){
        intercalar_filas(f,f2);
    }
